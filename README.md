...
[![deps](https://juliahub.com/docs/CDE_jll/deps.svg)](https://juliahub.com/ui/Packages/CDE_jll/coiAU?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/2cbdd1217fb542c693a6bea0a73fb9b0158b1603/C/CDE/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `CDE_jll.jl` have been built from these sources:

* git repository: https://github.com/HabershonLab/cde (revision: `049cd0d2da73a0c5bb340ebdb9a78e35348fe49a`)

## Platforms

`CDE_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `CDE_jll.jl`:
